...
extern void EKF_initializer();
extern void EKF_terminator();
...
extern mxArray* load_EKF_optimization_info(boolean_T isRtwGen, boolean_T
  isModelRef, boolean_T isExternal);
extern void unload_EKF_optimization_info(void);
