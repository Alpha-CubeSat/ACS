...
MODEL                = starshot_sim
MODULES              = rtGetInf.c rtGetNaN.c rt_nonfinite.c starshot_sim.c starshot_sim_capi.c starshot_sim_data.c starshot_sim_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = starshot_sim.exe
MAKEFILE             = starshot_sim.mk
MATLAB_ROOT          = E:/Matlab
ALT_MATLAB_ROOT      = E:/Matlab
START_DIR            = C:/Users/Deemo/Desktop/ACS/main
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/starshot_sim \
