...
extern void Plantv3_derivatives(void);
extern "C" {
...
void Plantv3_step(void)
{
  ...
  // Outputs for Atomic SubSystem: '<Root>/Plantv3'
  ...
  rtb_Sqrt = std::sqrt((rtX.Integrator_CSTATE * rtX.Integrator_CSTATE +
  ...
  rtb_Sqrt = 6.378E+6 / std::sqrt((rtX.Integrator_CSTATE * rtX.Integrator_CSTATE
    + rtX.Integrator1_CSTATE_c * rtX.Integrator1_CSTATE_c) +
    rtX.Integrator2_CSTATE * rtX.Integrator2_CSTATE);
  ...
  rtb_Sqrt = rtb_Sqrt * rtb_Sqrt * rtb_Sqrt * -3.12E-5;
  ...
  rtb_Sum5_m = 1.5707963267948966 - rt_atan2d_snf(rtX.Integrator2_CSTATE, std::
    sqrt(rtX.Integrator_CSTATE * rtX.Integrator_CSTATE +
         rtX.Integrator1_CSTATE_c * rtX.Integrator1_CSTATE_c));
  ...
  rtb_Divide3 = 2.0 * rtb_Sqrt * std::cos(rtb_Sum5_m);

  // Product: '<S4>/Divide4' incorporates:
  //   Trigonometry: '<S4>/Trigonometric Function4'

  rtb_Divide4 = rtb_Sqrt * std::sin(rtb_Sum5_m);
  ...
  rtb_Divide_e = std::cos(-rtb_Sum5_m) * rtb_Divide4 + std::sin(-rtb_Sum5_m) *
    rtb_Divide3;
  ...
  rtb_Sqrt = rtb_Divide_e * std::sin(rtb_TrigonometricFunction);

  // Product: '<S9>/Divide1' incorporates:
  //   Trigonometry: '<S9>/Trigonometric Function1'

  rtb_Divide_e *= std::cos(rtb_TrigonometricFunction);
  ...
  rtb_Sum5_m = std::cos(-rtb_Sum5_m) * rtb_Divide3 - std::sin(-rtb_Sum5_m) *
    rtb_Divide4;
  ...
  rtb_Divide3 = rtb_TmpSignalConversionAtMatrix[1] * rtb_Sum5_m;
  rtb_Divide4 = rtb_TmpSignalConversionAtMatrix[2] * rtb_Divide_e;
  ...
  rtb_Elementproduct_idx_4 = rtb_TmpSignalConversionAtMatrix[0] * rtb_Sum5_m;
  rtb_Elementproduct_idx_5 = rtb_TmpSignalConversionAtMatrix[1] * rtb_Divide_e;
  ...
  rtb_Divide3 = (rtb_Divide3 - rtb_Elementproduct_idx_3) -
    (rtX.Integrator10_CSTATE * rtb_TmpSignalConversionAtMatrix[2] -
     rtX.Integrator11_CSTATE * rtb_TmpSignalConversionAtMatrix[1]);
  rtb_Divide4 = (rtb_Divide4 - rtb_Elementproduct_idx_4) -
    (rtX.Integrator11_CSTATE * rtb_TmpSignalConversionAtMatrix[0] -
     rtX.Integrator9_CSTATE * rtb_TmpSignalConversionAtMatrix[2]);
  ...
  for (i = 0; i < 3; i++) {
    rtDW.Product1[i] = 0.0;
    rtDW.Product1[i] += rtConstP.Constant1_Value[i] * rtb_Divide3;
    rtDW.Product1[i] += rtConstP.Constant1_Value[i + 3] * rtb_Divide4;
  ...
  rtb_Divide3 = ((rtX.Integrator1_CSTATE[0] * rtX.Integrator1_CSTATE[0] +
  ...
  if (rtb_Divide3 < 0.0) {
    rtb_Divide3 = -std::sqrt(std::abs(rtb_Divide3));
  } else {
    rtb_Divide3 = std::sqrt(rtb_Divide3);
  }
  ...
  rtY.quaternion[0] = rtX.Integrator1_CSTATE[0] / rtb_Divide3;
  rtY.quaternion[1] = rtX.Integrator1_CSTATE[1] / rtb_Divide3;
  rtY.quaternion[2] = rtX.Integrator1_CSTATE[2] / rtb_Divide3;
  rtY.quaternion[3] = rtX.Integrator1_CSTATE[3] / rtb_Divide3;
  ...
  rtb_Divide3 = rtY.quaternion[3] * rtY.quaternion[3] - ((rtY.quaternion[0] *
    rtY.quaternion[0] + rtY.quaternion[1] * rtY.quaternion[1]) + rtY.quaternion
    [2] * rtY.quaternion[2]);
  ...
  rtDW.qd1 = ((rtY.quaternion[3] * rtX.Integrator9_CSTATE - rtY.quaternion[2] *
               rtX.Integrator10_CSTATE) + rtY.quaternion[1] *
  ...
  rtDW.qd2 = ((rtY.quaternion[2] * rtX.Integrator9_CSTATE + rtY.quaternion[3] *
               rtX.Integrator10_CSTATE) - rtY.quaternion[0] *
              rtX.Integrator11_CSTATE) / 2.0;
  ...
  rtDW.qd3 = ((-rtY.quaternion[1] * rtX.Integrator9_CSTATE + rtY.quaternion[0] *
               rtX.Integrator10_CSTATE) + rtY.quaternion[3] *
              rtX.Integrator11_CSTATE) / 2.0;
  ...
  rtDW.qd4 = ((-rtY.quaternion[0] * rtX.Integrator9_CSTATE - rtY.quaternion[1] *
               rtX.Integrator10_CSTATE) - rtY.quaternion[2] *
              rtX.Integrator11_CSTATE) / 2.0;
  ...
  for (i = 0; i < 3; i++) {
    tmp_1[3 * i] = (tmp[3 * i] * 2.0 - tmp_0[3 * i] * rtb_Divide4 * 2.0) +
      rtConstP.MatrixGain_Gain[3 * i] * rtb_Divide3;
    tmp_1[1 + 3 * i] = (tmp[3 * i + 1] * 2.0 - tmp_0[3 * i + 1] * rtb_Divide4 *
                        2.0) + rtConstP.MatrixGain_Gain[3 * i + 1] * rtb_Divide3;
    tmp_1[2 + 3 * i] = (tmp[3 * i + 2] * 2.0 - tmp_0[3 * i + 2] * rtb_Divide4 *
                        2.0) + rtConstP.MatrixGain_Gain[3 * i + 2] * rtb_Divide3;
  }

  // End of Sum: '<S7>/Sum8'
  // End of Outputs for SubSystem: '<S1>/qtoQ'
  // End of Outputs for SubSystem: '<Root>/Plantv3'
  ...
  for (i = 0; i < 3; i++) {
    ...
    rtY.magneticfield[i] += tmp_1[i] * rtb_Divide_e;
    rtY.magneticfield[i] += tmp_1[i + 3] * rtb_Sqrt;
    rtY.magneticfield[i] += tmp_1[i + 6] * rtb_Sum5_m;
...
void Plantv3_derivatives(void)
{
  XDot *_rtXdot;
  _rtXdot = ((XDot *) rtM->derivs);

  // Derivatives for Atomic SubSystem: '<Root>/Plantv3'
  ...
  // End of Derivatives for SubSystem: '<Root>/Plantv3'
}

// Model initialize function
void Plantv3_initialize(void)
{
  // Registration code
  ...
  // SystemInitialize for Atomic SubSystem: '<Root>/Plantv3'
  ...
  // End of SystemInitialize for SubSystem: '<Root>/Plantv3'
}
