###########################################################################
## Makefile generated for Simulink model 'Plantv2'. 
## 
## Makefile     : Plantv2.mk
## Generated on : Tue Apr 10 17:02:51 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Plantv2.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/armen/Documents/MATLAB/starshot
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = Plantv2_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = Plantv2_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Plantv2.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Plantv2_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Plantv2 -DNUMST=2 -DNCSTATES=13 -DHAVESTDIO
...
SRCS = $(START_DIR)/Plantv2_ert_rtw/Plantv2.c $(START_DIR)/Plantv2_ert_rtw/Plantv2_data.c

MAIN_SRC = $(START_DIR)/Plantv2_ert_rtw/ert_main.c
...
OBJS = Plantv2.obj Plantv2_data.obj
...
%.obj : $(START_DIR)/Plantv2_ert_rtw/%.c
	$(CC) $(CFLAGS) -Fo"$@" $(subst /,\,"$<")
