###########################################################################
## Makefile generated for Simulink model 'Plant'. 
## 
## Makefile     : Plant.mk
## Generated on : Fri Mar 09 22:40:14 2018
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Plant.exe
...
MODELREF_LINK_RSPFILE_NAME = Plant_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Plant.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/Plant_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=Plant -DNUMST=1 -DNCSTATES=13 -DHAVESTDIO
...
SRCS = $(START_DIR)/Plant_ert_rtw/Plant.c $(START_DIR)/Plant_ert_rtw/Plant_data.c

MAIN_SRC = $(START_DIR)/Plant_ert_rtw/ert_main.c
