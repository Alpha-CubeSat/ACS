...
void StarshotACS::step()
{
  ...
  rtb_Product1[0] = 0.004 * -rtDW.DiscreteTimeIntegrator_DSTATE[0];
  ...
  rtb_Product1[1] = 0.004 * -rtDW.DiscreteTimeIntegrator_DSTATE[1];
  ...
  rtb_Product1[2] = 0.004 * -rtDW.DiscreteTimeIntegrator_DSTATE[2];
  ...
  for (i = 0; i < 3; i++) {
    ...
    tmp_0 += rtU.Bfield_body[i] * rtU.Bfield_body[i];
  ...
  if (((rtb_Normalization[0] + rtb_Normalization[1]) + rtb_Normalization[2]) *
      (1.0 / std::sqrt(u2_tmp)) / std::sqrt(tmp_0) > 0.0) {
    i = 1;
  } else {
    i = -1;
  }
  ...
  for (i = 0; i < 3; i++) {
    ...
    rtDW.DiscreteTimeIntegrator_DSTATE[i] += ((0.0 - (acc - rtDW.UD_DSTATE[i]))
      - ((476.1904761904762 * -rtb_Gain2_idx_0 * 0.004 *
          rtb_VectorConcatenate_0[i] + 476.1904761904762 * -rtb_Gain2_idx_1 *
          0.004 * rtb_VectorConcatenate_0[i + 3]) + 476.1904761904762 *
         -rtb_Gain2_0 * 0.004 * rtb_VectorConcatenate_0[i + 6])) * 0.2;
